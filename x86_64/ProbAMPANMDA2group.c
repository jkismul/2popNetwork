...
#define nrn_init _nrn_init__ProbAMPANMDA2group
#define _nrn_initial _nrn_initial__ProbAMPANMDA2group
#define nrn_cur _nrn_cur__ProbAMPANMDA2group
#define _nrn_current _nrn_current__ProbAMPANMDA2group
#define nrn_jacob _nrn_jacob__ProbAMPANMDA2group
#define nrn_state _nrn_state__ProbAMPANMDA2group
#define _net_receive _net_receive__ProbAMPANMDA2group 
#define printVec printVec__ProbAMPANMDA2group 
#define setVec setVec__ProbAMPANMDA2group 
#define setRNG setRNG__ProbAMPANMDA2group 
#define state state__ProbAMPANMDA2group 
...
#define u0 _p[9]
#define Nsyns _p[10]
#define weight_factor_NMDA _p[11]
#define i _p[12]
#define i_AMPA _p[13]
#define i_NMDA _p[14]
#define g_AMPA _p[15]
...
#define erand erand_ProbAMPANMDA2group
 extern double erand( );
 /* declare global and static user variables */
#define mggate mggate_ProbAMPANMDA2group
 double mggate = 0;
#define mg mg_ProbAMPANMDA2group
 double mg = 1;
 ...
 "mg_ProbAMPANMDA2group", &mg_ProbAMPANMDA2group,
 "mggate_ProbAMPANMDA2group", &mggate_ProbAMPANMDA2group,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 7;
 	...
 	ivoc_help("help ?1 ProbAMPANMDA2group /home/janfki/Desktop/put_neuron_here/minimized/ProbAMPANMDA2group.mod\n");
...
{
 { error =  state();
 if(error){fprintf(stderr,"at line 106 in file ProbAMPANMDA2group.mod:\n        SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/janfki/Desktop/put_neuron_here/minimized/ProbAMPANMDA2group.mod";
static const char* nmodl_file_text = 
