...
#define nrn_init _nrn_init__ProbUDFsyn2group
#define _nrn_initial _nrn_initial__ProbUDFsyn2group
#define nrn_cur _nrn_cur__ProbUDFsyn2group
#define _nrn_current _nrn_current__ProbUDFsyn2group
#define nrn_jacob _nrn_jacob__ProbUDFsyn2group
#define nrn_state _nrn_state__ProbUDFsyn2group
#define _net_receive _net_receive__ProbUDFsyn2group 
#define printVec printVec__ProbUDFsyn2group 
#define setVec setVec__ProbUDFsyn2group 
#define setRNG setRNG__ProbUDFsyn2group 
#define state state__ProbUDFsyn2group 
...
#define erand erand_ProbUDFsyn2group
 extern double erand( );
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 7;
 	...
 	ivoc_help("help ?1 ProbUDFsyn2group /home/janfki/Desktop/put_neuron_here/minimized/ProbUDFsyn2group.mod\n");
...
{
 { error =  state();
 if(error){fprintf(stderr,"at line 90 in file ProbUDFsyn2group.mod:\n        SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/janfki/Desktop/put_neuron_here/minimized/ProbUDFsyn2group.mod";
static const char* nmodl_file_text = 
